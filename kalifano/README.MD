...
```bash
sbatch just_lunch2.bash simple_prompt_local_llm.py
```
...
- The `just_lunch2.bash` script activates the `ai2MDE` conda environment automatically
...
### 4) Troubleshooting model downloads and auth
